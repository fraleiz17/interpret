...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=2340 AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `sexo` boolean NOT NULL DEFAULT '0' COMMENT '0 - hombre',
...
INSERT INTO `idiomas` ('idiomaID', 'idioma') values ('2', 'LSM');
...
ALTER TABLE `usuariodato`
  ADD CONSTRAINT `adicional` FOREIGN KEY (`usuarioID`) REFERENCES `usuario` (`usuarioID`) ON DELETE CASCADE ON UPDATE CASCADE;
