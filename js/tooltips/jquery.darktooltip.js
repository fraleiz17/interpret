	...
	DarkTooltip.prototype = {
		...
		setEvents: function(){
			...
			if(dt.mouseOverMode){
				...
				this.tooltip.on( function(e){
					e.stopPropagation();
				});
				this.bearer.on( function(e){
					e.preventDefault();
					dt.setPositions();
					dt.toggle();
					e.stopPropagation();
		...
		setConfirmEvents: function(){
			var dt = this;
			this.tooltip.find('li.darktooltip-yes').on( function(e){
				dt.onYes();
				e.stopPropagation();
			});
			this.tooltip.find('li.darktooltip-no').on( function(e){
				dt.onNo();
				e.stopPropagation();
			});
		},
